...
const DETAIL_META: Record<string, { label: string; kode: string; format: "rp" | "num" }> = {
  ...
  nilaiBeli: { label: "Nilai Beli", kode: "Kolom 6", format: "rp" },
  banyakNonbeli: { label: "Banyak Nonbeli", kode: "Kolom 7", format: "num" },
  nilaiNonbeli: { label: "Nilai Nonbeli", kode: "Kolom 8", format: "rp" },
  satuan: { label: "Satuan", kode: "KOLOM9", format: "num" },
  nomorUrutArt: { label: "Nomor Urut ART", kode: "R401", format: "num" },
