// app/api/penyisiran/tetangga-list/route.ts
//
// Daftar keluarga versi RINGAN utk tab "Identifikasi Tetangga/Lainnya" --
// SAMA PERSIS dgn /api/penyisiran/jorong-list (kolom, filter manual
// kec/nagari/subsls, tanpa bukti DUTP/DTSEN/PNM atau koordinat GPS),
// bedanya cuma role yang diterima ("identifikasi_tetangga").
...
const KOLOM =
  ...
  "nama_kk, alamat, identifikasi_ppl, identifikasi_ppl_at, identifikasi_ppl_oleh";

export async function GET(req: NextRequest) {
  if (!verifySession(extractBearer(req), ["penyisiran", "identifikasi_tetangga"])) {
